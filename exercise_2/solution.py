...
# that looks like my above examples for Python 3's "range" function.
#
# Note that the printed representation doesn't have to look the same.
#
...
def myrange2(min, max=None, every=1):
...
print(myrange2(5))
print(myrange2(5,10))
print(myrange2(5,20,3))

def myrange3(min, max=None, every=1):
    if min and not max:
        max = min
        min = 0
...
print(list(myrange3(5)))
print(list(myrange3(5, 10)))
print(list(myrange3(5, 20, 3)))
